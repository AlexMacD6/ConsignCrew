...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      // Redirect to Better Auth's Google OAuth flow for registration
      window.location.href =
        "/api/auth/[...betterauth]?action=signUp&provider=google";
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fffbe6] via-[#f7f7f7] to-[#f7f7f7]">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full mb-4 py-2 px-4 border border-gray-300 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition disabled:opacity-50"
        >
