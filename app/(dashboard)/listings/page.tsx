              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden">
                  ...
                  {(() => {
                    ...
                    const hasRecentPriceDrop = Math.random() > 0.7; // 30% chance for demo
                  ...
                  {(() => {
                    ...
                    return (
                      nextDrop && (
                        <div className="absolute bottom-2 left-20 bg-red-600 text-white px-2 py-1 rounded text-xs flex items-center gap-1">
                ...
                <div className="p-4">
                  ...
                  {/* Serial/Model Numbers - Only show if they exist */}
                  {(listing.serial_number || listing.model_number) && (
                    <div className="text-xs text-gray-400 mb-3">
                      {listing.serial_number && (
                        <div className="flex items-center gap-1">
                          <Tag className="h-3 w-3" />
                          SN: {listing.serial_number}
                        </div>
                      )}
                      {listing.model_number && (
                        <div className="flex items-center gap-1">
                          <Tag className="h-3 w-3" />
                          Model: {listing.model_number}
                        </div>
                      )}
                    </div>
                  )}
                ...
                <div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-4">
                      {questions
                        .filter((q) => q.item_id === selectedListing.item_id)
                        .map((question) => (
                          <div
                            key={question.id}
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-500">
                              <span>
                                ...
                                on {formatDate(question.asked_at)}
                              </span>
                            ...
                            {question.answer &&
                              !question.is_public &&
                              isAdmin && (
                                <div className="mt-3 flex items-start gap-2 text-sm text-gray-500 bg-yellow-50 p-3 rounded border-l-2 border-yellow-400">
                      ...
                      {questions.filter(
                        (q) => q.item_id === selectedListing.item_id
                      ).length === 0 && (
