        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
            ...
            <div className="flex items-center gap-2 bg-gray-700 px-4 py-2 rounded-lg">
              ...
              <span className="text-sm font-medium">AWS Secured</span>
            </div>
            ...
            <div className="flex items-center gap-2 bg-gray-700 px-4 py-2 rounded-lg">
              ...
              <span className="text-sm font-medium">Neon Database</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Professional consignment service that handles everything from
              pickup to sale. We clean, photograph, authenticate, and sell your
              items with transparent pricing.
            </p>
            <div className="flex space-x-4">
              {/* X (Twitter) */}
              <a
                href="https://x.com/TreasureHubClub"
                target="_blank"
              ...
              {/* Facebook */}
              <a
                href="https://facebook.com/treasurehubclub"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/treasurehubclub/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@treasurehubclub"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              ...
              {policiesOpen && (
                <div className="absolute bottom-full left-0 mb-2 w-64 bg-gray-800 rounded-lg shadow-lg border border-gray-700 z-10">
                  <div className="p-4 space-y-2">
                    ...
                    <Link
                      href="/policies/cyber-incident-response-plan"
                      className="block text-gray-300 hover:text-white transition-colors py-1"
                    >
                      Cyber Incident Response Plan
                    </Link>
                    <Link
                      href="/policies/site-guidelines"
                      className="block text-gray-300 hover:text-white transition-colors py-1"
                    >
                      Site Guidelines
                    </Link>
